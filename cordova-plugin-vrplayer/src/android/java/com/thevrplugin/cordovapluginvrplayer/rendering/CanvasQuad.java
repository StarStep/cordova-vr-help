...
package com.thevrplugin.cordovapluginvrplayer.rendering;

import static com.thevrplugin.cordovapluginvrplayer.rendering.Utils.checkGlError;
...
public class CanvasQuad {
  ...
  private static final float[] vertexData = {
    -WIDTH / 2, -HEIGHT / 2, -DISTANCE, 0, 1,
     WIDTH / 2, -HEIGHT / 2, -DISTANCE, 1, 1,
    -WIDTH / 2,  HEIGHT / 2, -DISTANCE, 0, 0,
     WIDTH / 2,  HEIGHT / 2, -DISTANCE, 1, 0
  };
